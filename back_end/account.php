                ...
                <div class="col-md-3">
                    <div class="nav flex-column nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <div class="main" style="width: 100%;">
                            <img src="assets/img/2.png" class="img">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active text-right" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            ...
                            <form class="sign" action="#">
                                ...
                                <input type="text" placeholder="<?php echo $info['username']; ?>"  disabled>
                                <label for="email">&#8592; البريد الالكتروني</label>
                                <input type="text" placeholder="<?php echo $info['email']; ?>"  disabled>
                                <label for="phone">&#8592; رقم الهاتف</label>
                                <input type="text" placeholder="<?php echo $info['phone']; ?>"  disabled>
                                <label for="group">&#8592; الصف الدراسى</label>
                                <input type="text" placeholder="<?php echo $category_name['category_name'];?>"  disabled >
                                <label for="date">&#8592; تاريخ التسجيل</label>
                                <input type="text" placeholder="<?php echo $info['date']; ?>" disabled>
                            </form>
                        </div>
